...
#ifndef ROSCOIN_CHECKPOINT_H
#define  ROSCOIN_CHECKPOINT_H

#include <map>
#include "net.h"
#include "util.h"

#define CHECKPOINT_MAX_SPAN (5 * 60) // max 5 minutes before latest block
...
// roscoin: synchronized checkpoint
