...
#ifndef H_ROSCOIN_SCRIPT
#define H_ROSCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CRoscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Roscoin always counted CHECKMULTISIGs
