...
static const CRoscoinAddress addr1 ("1QFqqMUD55ZV3PJEJZtaKCsQmjLT6JkjvJ");
static const CRoscoinAddress addr2 ("1F5y5E5FMc5YzdJtB9hLaUe43GDxEKXENJ");
static const CRoscoinAddress addr1C("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
static const CRoscoinAddress addr2C("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CRoscoinAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CRoscoinSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
