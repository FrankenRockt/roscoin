    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a Roscoin address (e.g. RDpMjTmJ4UqzVt6BL59Ymsynhz5cDhu5mx)"));
	ui->narration->setPlaceholderText(tr("Enter a short note to send with payment."));
