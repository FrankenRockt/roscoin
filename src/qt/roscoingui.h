...
/**
  Roscoin GUI main class. This class represents the main window of the Roscoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RoscoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit RoscoinGUI(QWidget *parent = 0);
    ~RoscoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a roscoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
