...
contains(ROSCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += ROSCOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/roscoingui.h \
    ...
    src/qt/roscoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/roscoin.cpp src/qt/roscoingui.cpp \
    ...
    src/qt/roscoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/smessage.cpp \
    ...
    src/qt/roscoinstrings.cpp \
    src/qt/roscoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/roscoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/roscoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/roscoin-qt.rc
...
windows:RC_FILE = src/qt/res/roscoin-qt.rc
...
macx:ICON = src/qt/res/icons/roscoin.icns
macx:TARGET = "roscoin-Qt"
